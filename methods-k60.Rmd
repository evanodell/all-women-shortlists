...
write_rds(topic_model_k60, "data/topic_model_k60.rds")
```
...
topic_model_k60 <- read_rds("data/topic_model_k60.rds")
...
write_rds(topic_model_man_k60, "data/topic_model_man_k60.rds")
write_rds(new_man_k60, "data/new_man_k60.rds")
...
write_rds(corr_topic_K60, "data/corr_topic_K60.rds")

write_rds(prep_K60, "data/prep_K60.rds")
```
...
corr_topic_K60 <- read_rds("data/corr_topic_K60.rds")

prep_K60 <- read_rds("data/prep_K60.rds")
