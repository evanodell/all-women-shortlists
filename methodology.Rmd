...
write_rds(all_speech, "senti_df2.rds")
...
lab_speech$speech <- gsub( " *\\(.*?\\)*", "", lab_speech$speech)

lab_speech$speech <- gsub( " *\\[.*?\\]*", "", lab_speech$speech)

lab_speech$speech <- gsub( "^c\\(", "", lab_speech$speech)
...
write_rds(lab_nums, "lab_nums.rds")
...
lab_nums <- read_rds("lab_nums.rds")
```
...
search_results <- searchK(documents = lab_corpus_fem_stm$documents, 
                          vocab = lab_corpus_fem_stm$vocab, 
                          K = c(10, 30, 50, 75, 100),
                          prevalence = ~short_list, 
...
kable(prep_df_k45_2,  booktabs = TRUE, longtable = TRUE, 
  ...
  group_rows(index = c("Topic 1 -- Business" = 2,
                        ...
                        "Topic 18 -- Universities and Skills" = 2,
                        "Topic 19 -- Schools" = 2,
                        "Topic 20 -- Transport" = 2,
                        "Topic 21 -- Police" = 2,
                        "Topic 22 -- Budgets and tax" = 2,
                        "Topic 23 -- Drugs" = 2,
                        "Topic 24 -- Culture and sport" = 2,
                        "Topic 25 -- Children and families" = 2,
                        "Topic 26 -- Planning and land-use" = 2,
                        "Topic 27 -- Security" = 2,
                        "Topic 28 -- Elections" = 2,
                        "Topic 29 -- Benefits and pensions" = 2,
...
prep_df_k45_sig_check <- prep_df_k45 %>% 
   mutate(topic = recode(topic,
                        ...
                        "26" = "Planning and land-use",
                        "27" = "Security",
                        "28" = "Elections",
                        "29" = "Benefits and pensions",
                        "30" = "Call to action",
                        "31" = "Reports",
                        "32" = "Disability",
                        "33" = "Amendments",
...
topic_dt_k45_div <- topic_dt_k45 %>% 
  ...
  select(assigned_topic, distinct, distinct_n5) %>%
   mutate(assigned_topic = recode(assigned_topic,
                                  ...
                                  "Topic 5" = "5 -- Housing",
                                  "Topic 6" = "6 -- Questions",
                                  "Topic 7" = "7 -- Technology",
                                  "Topic 8" = "8 -- Food and farming",
                                  "Topic 9" = "9 -- Animals",
                                  "Topic 10" = "10 -- Disease",
                                  "Topic 11" = "11 -- Parties",
                                  "Topic 12" = "12 -- Health Care",
                                  "Topic 13" = "13 -- Disasters",
                                  "Topic 14" = "14 -- Energy",
                                  "Topic 15" = "15 -- Volunteering",
                                  "Topic 16" = "16 -- Infrastructure",
                                  "Topic 17" = "17 -- Local authorities",
                                  "Topic 18" = "18 -- Universities and Skills",
                                  "Topic 19" = "19 -- Schools",
                                  "Topic 20" = "20 -- Transport",
                                  "Topic 21" = "21 -- Police",
                                  "Topic 22" = "22 -- Budgets and tax",
                                  "Topic 23" = "23 -- Drugs",
                                  "Topic 24" = "24 -- Culture and sport",
                                  "Topic 25" = "25 -- Children and families",
                                  "Topic 26" = "26 -- Planning and land-use",
                                  "Topic 27" = "27 -- Security",
                                  "Topic 28" = "28 -- Elections",
                                  "Topic 29" = "29 -- Benefits and pensions",
                                  "Topic 30" = "30 -- Call to action",
                                  "Topic 31" = "31 -- Reports",
                                  "Topic 32" = "32 -- Disability",
                                  "Topic 33" = "33 -- Amendments",
                                  "Topic 34" = "34 -- Justice",
                                  "Topic 35" = "35 -- Military intervention",
                                  "Topic 36" = "36 -- Financial system",
                                  "Topic 37" = "37 -- Debate",
                                  "Topic 38" = "38 -- Public bodies",
                                  "Topic 39" = "39 -- Devolution",
                                  "Topic 40" = "40 -- Bills",
                                  "Topic 41" = "41 -- European Union",
                                  "Topic 42" = "42 -- Environment",
                                  "Topic 43" = "43 -- Constituency",
                                  "Topic 44" = "44 -- Responses",
                                  "Topic 45" = "45 -- Interventions"),
          assigned_topic = factor(assigned_topic, 
                                  levels=c("1 -- Business", 
                                           "2 -- Roads", 
                                           "3 -- Members", 
                                           "4 -- Gender", 
...
kable(topic_dt_k45_div[1:3],  booktabs = TRUE, longtable = TRUE, 
...
topic_dt_k45_6 <- topic_dt_k45_3 %>% 
  ...
  mutate(assigned_topic = factor(assigned_topic, 
          ...
          assigned_topic = recode(assigned_topic,
                                  ...
                                  "Topic 18" = "Universities and Skills",
                                  "Topic 19" = "Schools",
                                  "Topic 20" = "Transport",
                                  "Topic 21" = "Police",
                                  "Topic 22" = "Budgets and tax",
                                  "Topic 23" = "Drugs",
                                  "Topic 24" = "Culture and sport",
                                  "Topic 25" = "Children and families",
                                  "Topic 26" = "Planning and land-use",
                                  "Topic 27" = "Security",
                                  "Topic 28" = "Elections",
                                  "Topic 29" = "Benefits and pensions",
