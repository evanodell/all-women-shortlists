...
- check citations of roberts 2016 to see how other people use it/select K
...
new_man <- alignCorpus(new=lab_corpus_man_stm, old.vocab=topic_model_k30$vocab)
...
write_rds(topic_model_man_k30, "topic_model_man.rds")
write_rds(new_man_k30, "new_man_k30.rds")
...
[INSERT ANALYSIS AND DISCUSSION OF GRAPH]
