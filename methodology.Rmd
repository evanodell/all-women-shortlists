...
ggsave("p_k_result.svg", plot = p_k_result, path="plots", device = "svg",
       width = 20, height = 20, units = "cm")
  ...
  spread(key = "short_list_g", value = "count") %>%
   ...
   mutate(assigned_topic = factor(assigned_topic, levels=c(
          ...
          assigned_topic = recode(assigned_topic, 
                          "Topic 1" = "(1) Employment/Trade Unions",
                          "Topic 2" = "(2) Legal System",
                          "Topic 3" = "(3) Roads",
                          "Topic 4" = "(4) Housing",
                          "Topic 5" = "(5) Police, Firefighters, Prisons",
                          ...
                          "Topic 32" = "(32) Reports",
                          "Topic 33" = "(33) People",
                          "Topic 34" = "(34) Wales and Scotland",
                          "Topic 35" = "(35) Alcohol and tobacco",
                          "Topic 36" = "(36) Place names",
                          "Topic 37" = "(37) Budget",
                          "Topic 38" = "(38) Tax",
                          "Topic 39" = "(39) Private companies",
                          "Topic 40" = "(40) Environment and Fishing",
                          "Topic 41" = "(41) Crime",
                          "Topic 42" = "(42) Bills",
