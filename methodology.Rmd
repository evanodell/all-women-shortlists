...
The R package `stm` [@roberts2018] implements a structured topic model [@roberts2016; @arora2013]

<!--
We used an algorith developed by Lee and Mimno [-@lee2014c], implemented in the `stm` package [@roberts2018], to estimate the number of topics across all speeches made by female Labour MPs. The resulting topic model has 49 topics, 81607 documents and a 115477 word dictionary. <!--We then used `stm`'s implementation of Latent Dirichlet Allocation [@blei2003]-->
...
topic_model <- read_rds("stm-topic-model.rds")
