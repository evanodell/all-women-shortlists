...
kable(labour_intakes_table, booktabs = TRUE,
  ...
  kable_styling(latex_options = c("basic",  "HOLD_position"), full_width = FALSE)
} else { 
  kable(labour_intakes_table, booktabs = TRUE,
      digits = 2,
      align = c("r","r","r","r","r","r","r","r"),
  ...
  column_spec(6:7, width = "1.5cm") %>%
  column_spec(8, width = "2cm") %>%
  kable_styling(bootstrap_options = c("basic",  "HOLD_position"))
  } 
```
...
if (knitr::is_latex_output()) {
  ...
  add_header_above(c(" " = 1, "Women" = 2, "Men" = 2, "Effect Size" = 2))
    ...
    kable(fem_mac_df, booktabs = TRUE, digits = 2, 
      caption = "Effect Sizes for Male and Female Labour MPs",
      col.names = c("", "Women Mean", "Women SD", "Men Mean", "Men SD",
                    "Cohen's d", "Magnitude") )  %>%
  kable_styling(bootstrap_options = c("basic",  "HOLD_position")) #%>% 
  #add_header_above(c(" " = 1, "Women" = 2, "Men" = 2, "Effect Size" = 2))
  } 
...
if (knitr::is_latex_output()) {
  ...
  add_header_above(c(" " = 1, "All Women Shortlists" = 2,
                     "Open Shortlists" = 2, "Effect Size" = 2))
} else {
  kable(fem_mac_df_sl, booktabs = TRUE, digits = 2, 
      caption = "Effect Sizes for Female Labour MPs by selection process",
      col.names = c("", "All Women Shortlists Mean", "All Women Shortlists SD",
                    "Open Shortlists Mean", "Open Shortlists SD",
                    "Cohen's d", "Magnitude")) %>%
  kable_styling(bootstrap_options = c("basic",  "HOLD_position")) #%>% 
  # add_header_above(c(" " = 1, "All Women Shortlists" = 2,
  #                    "Open Shortlists" = 2, "Effect Size" = 2))
...
if (knitr::is_latex_output()) {
  ...
  kable(lab_con_df, booktabs = TRUE, digits = 2, escape = FALSE,
      caption = "Effect Sizes for All Labour and Conservative MPs",
      col.names = c("", "Labour Mean", "Labour SD", "Conservatives Mean",
                    "Conservatives SD", "Cohen's <em>d</em>", "Magnitude") )  %>%
  kable_styling(bootstrap_options = c("basic",  "HOLD_position")) #%>% 
  # add_header_above(c(" " = 1, "Labour" = 2,
  #                    "Conservatives" = 2, "Effect Size" = 2))
}
...
if (knitr::is_latex_output()) {
  ...
  kable(pos_df_gender, booktabs = TRUE, digits = 2, 
      caption = "Part-of-Speech Effect Sizes for Male and Female Labour MPs",
      col.names = c("Word Type", "Women Mean", "Women SD",
                    "Men Mean", "Men SD",
                    "Cohen's d", "Magnitude") )  %>%
  kable_styling(bootstrap_options = c("basic",  "HOLD_position"))
}
...
if (knitr::is_latex_output()) { 
  ...
  kable(pos_df_sl, booktabs = TRUE, digits = 2, 
      caption = "Part-of-Speech Effect Sizes for AWS and non-AWS Labour MPs",
      col.names = c("Word Type", "All Women Shortlists Mean", 
                    "All Women Shortlists SD", "Open Shorlists Mean",
                    "Open Shorlists SD", "Cohen's d", "Magnitude"))  %>%
  kable_styling(bootstrap_options = c("basic",  "HOLD_position"))
}
```
...
kable(prep_df_k0_2, booktabs = TRUE, longtable = TRUE, 
      ...
      col.names = c("", "", "Estimate", "Standard Error",
                    "t value", "Pr(>|t|)"),
      align = c("l","r","r","r","r")) %>%
  kable_styling(latex_options = c("basic", "HOLD_position",  "repeat_header"),
                full_width = TRUE ) %>%
  collapse_rows(columns = 1, valign = "middle")
} else {

kable(prep_df_k0_2, booktabs = TRUE,
      caption = "Topic Estimates",
      col.names = c("Topic", "Variables", "Estimate", "Standard Error",
                    "t value", "Pr(>|t|)"),
      align = c("l","r","r","r","r")) %>%
  kable_styling(bootstrap_options = c("basic", "HOLD_position")) %>%
  collapse_rows(columns = 1, valign = "middle")
...
if (knitr::is_latex_output()) {
  kable(topic_dt_assign_2, booktabs = TRUE, longtable = TRUE, 
...
kable(topic_words2, booktabs = TRUE, longtable = TRUE,
      ...
      col.names = c("Topic", "Top Twenty Words", "Top Twenty FREX")) %>%
    kable_styling(latex_options = c("basic", "HOLD_position",
                                    "repeat_header"), full_width = TRUE ) %>%
...
```{r aws-dif-table-making, include=FALSE}
library(dplyr)

prep_df_k0 <- prep_df_k0 %>% 
  mutate(topic_name = recode(topic,
                             "1" = "Topic 1, Employment & unions",
                             "2" = "Topic 2, Legal system",
                             "3" = "Topic 3, Roads",
                             "4" = "Topic 4, Housing",
                             "5" = "Topic 5, Police, firefighters & prison",
                             "6" = "Topic 6, Northern Ireland",
                             "7" = "Topic 7, Committee",
                             "8" = "Topic 8, Schools",
                             "9" = "Topic 9, Energy & climate change",
                             "10" = "Topic 10, Defence",
                             "11" = "Topic 11, Parliament",
                             "12" = "Topic 12, International politics",
                             "13" = "Topic 13, Ministers",
                             "14" = "Topic 14, Policy impact",
                             "15" = "Topic 15, Gender",
                             "16" = "Topic 16, Regional development",
                             "17" = "Topic 17, Communications",
                             "18" = "Topic 18, Immigration",
                             "19" = "Topic 19, Health system",
                             "20" = "Topic 20, International development",
                             "21" = "Topic 21, Benefits & disability",
                             "22" = "Topic 22, Sport & culture",
                             "23" = "Topic 23, History",
                             "24" = "Topic 24, Higher education & skills",
                             "25" = "Topic 25, Concurring point",
                             "26" = "Topic 26, Pensions",
                             "27" = "Topic 27, Points of order",
                             "28" = "Topic 28, Issues",
                             "29" = "Topic 29, Constituencies",
                             "30" = "Topic 30, Ethnic groups & racism",
                             "31" = "Topic 31, Amendments",
                             "32" = "Topic 32, Reports",
                             "33" = "Topic 33, People",
                             "34" = "Topic 34, Wales & Scotland",
                             "35" = "Topic 35, Alcohol & tobacco",
                             "36" = "Topic 36, Place names",
                             "37" = "Topic 37, Budget",
                             "38" = "Topic 38, Tax",
                             "39" = "Topic 39, Private companies",
                             "40" = "Topic 40, Environment & fishing",
                             "41" = "Topic 41, Crime",
                             "42" = "Topic 42, Bills",
                             "43" = "Topic 43, Children",
                             "44" = "Topic 44, Utilities & PFI",
                             "45" = "Topic 45, Middle East",
                             "46" = "Topic 46, Local authorities",
                             "47" = "Topic 47, Elections",
                             "48" = "Topic 48, Debate",
                             "49" = "Topic 49, Transport",
                             "50" = "Topic 50, Questions",
                             "51" = "Topic 51, Families",
                             "52" = "Topic 52, Health research",
                             "53" = "Topic 53, Dispatch box",
                             "54" = "Topic 54, Parties",
                             "55" = "Topic 55, Statements",
                             "56" = "Topic 56, European Union",
                             "57" = "Topic 57, Locations",
                             "58" = "Topic 58, Jobs & manufacturing",
                             "59" = "Topic 59, Small business",
                             "60" = "Topic 60, Agreement & disagreement",
                             "61" = "Topic 61, Voluntary sector",
                             "62" = "Topic 62, Comments",
                             "63" = "Topic 63, Social care",
                             "64" = "Topic 64, Time",
                             "65" = "Topic 65, Media & animals",
                             "66" = "Topic 66, Other"))

aws_diff <- prep_df_k0 %>%
  filter(p < 0.05 & type == "AWS" | p >= 0.05 & type == "Non-AWS") %>%
  filter(duplicated(topic)) %>% 
  mutate(direction = if_else(Estimate > 0, "Higher", "Lower"))

aws_diff_higher <- aws_diff %>% filter(direction == "Higher")

aws_diff_lower <- aws_diff %>% filter(direction == "Lower")

gender_diff <- prep_df_k0 %>%
  filter(p >= 0.05 & type == "AWS" | p >= 0.05 & type == "Non-AWS") %>%
  filter(duplicated(topic)) %>% 
  mutate(direction = if_else(Estimate > 0, "Higher", "Lower"))

non_aws_diff <- prep_df_k0 %>%
  filter(p >= 0.05 & type == "AWS" | p < 0.05 & type == "Non-AWS") %>%
  filter(duplicated(topic)) %>% 
  mutate(direction = if_else(Estimate > 0, "Higher", "Lower"))

non_aws_diff_higher <- non_aws_diff %>% filter(direction == "Higher")

non_aws_diff_lower <- non_aws_diff %>% filter(direction == "Lower")

women_split <- prep_df_k0 %>%
  filter(p < 0.05 & type == "AWS" | p < 0.05 & type == "Non-AWS") %>%
  group_by(topic) %>% mutate(n = n()) %>% filter(n > 1) %>% ungroup() %>%
  mutate(direction = if_else(Estimate > 0, "Higher", "Lower")) %>% 
  group_by(topic, direction) %>% distinct(direction, .keep_all = TRUE) %>%
  group_by(topic) %>% mutate(n = n()) %>% filter(n > 1)

women_split_aws_higher <- women_split %>%
  filter(type == "AWS" & direction == "Higher")

women_split_aws_lower <- women_split %>%
  filter(type == "AWS" & direction == "Lower")

women_same <- prep_df_k0 %>%
  filter(p < 0.05 & type == "AWS" | p < 0.05 & type == "Non-AWS") %>%
  group_by(topic) %>% mutate(n = n()) %>% filter(n > 1) %>% ungroup() %>%
  mutate(direction = if_else(Estimate > 0, "Higher", "Lower")) %>% 
  filter(!(topic %in% women_split$topic)) 
...
effect_compare <- extract.estimateEffect(x = prep_k0,
                                  covariate = "gender_sl",
                                  model = topic_model_k0) %>%
  mutate(type = recode(covariate.value,
                       "Male_FALSE" = "Male",
                       "Female_TRUE" = "AWS",
                       "Female_FALSE" = "Non-AWS"),
         type = as.character(type),
    assigned_topic = recode(topic,
                        "1" = "(1) Employment & unions",
                        "2" = "(2) Legal system",
                        "3" = "(3) Roads",
                        "4" = "(4) Housing",
                        ...
                        "7" = "(7) Committee",
                          ...
                          "65" = "(65) Media & animals",
                          "66" = "(66) Other"))  %>%
  mutate(assigned_topic = factor(
    assigned_topic, 
    levels=c("(1) Employment & unions",
           "(2) Legal system", "(3) Roads", "(4) Housing",
           "(5) Police, firefighters & prison", "(6) Northern Ireland",
           "(7) Committee", "(8) Schools", "(9) Energy & climate change",
           "(10) Defence", "(11) Parliament", "(12) International politics",
           "(13) Ministers", "(14) Policy impact", "(15) Gender",
           "(16) Regional development", "(17) Communications",
           "(18) Immigration", "(19) Health system",
           "(20) International development", "(21) Benefits & disability",
           "(22) Sport & culture", "(23) History",
           "(24) Higher education & skills", "(25) Concurring point",
           "(26) Pensions", "(27) Points of order", "(28) Issues",
           "(29) Constituencies", "(30) Ethnic groups & racism",
           "(31) Amendments", "(32) Reports", "(33) People", 
           "(34) Wales & Scotland", "(35) Alcohol & tobacco", 
           "(36) Place names", "(37) Budget", "(38) Tax", 
           "(39) Private companies", "(40) Environment & fishing", 
           "(41) Crime", "(42) Bills", "(43) Children", 
           "(44) Utilities & PFI", "(45) Middle East", 
           "(46) Local authorities", "(47) Elections", "(48) Debate", 
           "(49) Transport", "(50) Questions", "(51) Families", 
           "(52) Health research", "(53) Dispatch box", "(54) Parties", 
           "(55) Statements", "(56) European Union", "(57) Locations", 
           "(58) Jobs & manufacturing", "(59) Small business", 
           "(60) Agreement & disagreement", "(61) Voluntary sector", 
           "(62) Comments", "(63) Social care", "(64) Time", 
           "(65) Media & animals", "(66) Other"))) %>%
  arrange(assigned_topic)

effect_compare2 <- effect_compare %>%
  select(type, assigned_topic, estimate) %>%
  spread(type, estimate) %>%
  mutate(aws_vs_male = abs(Male - AWS),
         non_aws_vs_male = abs(Male - `Non-AWS`),
         aws_vs_non_aws = abs(`Non-AWS` - AWS))

effect_compare2 <- effect_compare2 %>% tibble::as_tibble() %>%
  mutate(bigger_diff = colnames(effect_compare2)[5:7][max.col(effect_compare2[5:7], 
                                                              ties.method="first")],
        fem_relative = case_when(
       aws_vs_male > non_aws_vs_male  ~ "Non-AWS more like male",
       aws_vs_male < non_aws_vs_male  ~ "AWS more like male"),
   all_diffs = case_when(
     (aws_vs_male + non_aws_vs_male)/2 > aws_vs_non_aws ~
       "Women more similar to each other",
     aws_vs_male > non_aws_vs_male  ~ "Non-AWS more like male",
     aws_vs_male < non_aws_vs_male  ~ "AWS more like male"),
     fem_relative = as.factor(fem_relative),
     all_diffs = as.factor(all_diffs),
   cv = (apply(effect_compare2[2:4], 1, raster::cv)),
   cv_fem = (apply(select(effect_compare2, AWS, `Non-AWS`), 1, raster::cv)),
   cv_sl_men = (apply(select(effect_compare2, AWS, Male), 1, raster::cv)),
   cv_non_sl_men = (apply(select(effect_compare2, Male, `Non-AWS`), 1, raster::cv))
   )

summary(effect_compare2$fem_relative)
summary(effect_compare2$all_diffs)
summary(effect_compare2$cv) ## Use the various CVs to identify which are most similar and most different to each other

effect_compare2$test <- effect_compare2$aws_vs_male/effect_compare2$non_aws_vs_male

effect_compare2$test2 <- effect_compare2$AWS/effect_compare2$`Non-AWS`


combined_effect <- effect_compare %>% inner_join(women_same) %>%
  select(-Estimate, -`Std. Error`, -covariate.value, -assigned_topic) %>%
  tibble::as.tibble() %>%
  group_by(topic, type) %>%
  mutate(check = list(range(ci.lower, ci.upper))) %>%
  ungroup() %>% 
  group_by(topic) 

combined_effect2 <- combined_effect %>%
  summarise(min_upper_ci = min(ci.upper),
            max_lower_ci = max(ci.lower)) %>%
  mutate(overlap = if_else(max_lower_ci >= min_upper_ci, "no", "yes"))

## this shows all non-overlapping categories
combined_effect3 <- combined_effect %>%
  left_join(combined_effect2) %>%
  filter(overlap == "no") %>%
  group_by(topic)
...
# 
# intersect.ranges(combined_effect$check, combined_effect$check2)
...
There are `r nrow(aws_diff)` topics where the frequency AWS MPs is significantly different from male MPs, but where its frequency amongst non-AWS MPs is not significantly different. They are topics `r aws_diff$topic`. `r nrow(aws_diff_higher)` topics are proportionally greater among AWS MPs (`r aws_diff_higher$topic_name`) and `r nrow(aws_diff_lower)` topics are less common (`r aws_diff_lower$topic_name`). 

There are `r nrow(non_aws_diff)` topics where its proportion amongst non-AWS MPs is significantly different from male MPs, but where its proportion amongst AWS MPs is not significantly different. They are topics `r non_aws_diff$topic`. `r nrow(non_aws_diff_higher)` topics are proportionally greater among AWS MPs (`r non_aws_diff_higher$topic_name`) and `r nrow(non_aws_diff_lower)` topics are less common (`r non_aws_diff_lower$topic_name`). 

There is `r nrow(gender_diff)` topic (`r gender_diff$topic_name`) where there is no significant difference in frequency among both AWS and non-AWS MPS, relative to male Labour MPs.

There are `r length(unique(women_split$topic_name))` topics where AWS and non-AWS MPs differ significantly in proportion from male Labour MPs, but are not both higher/lower than male MPs. AWS MPs are significantly more likely to mention `r nrow(women_split_aws_higher)` topics (`r women_split_aws_higher$topic_name`) than male MPs, while non-AWS mps are significantly less likely to mention those topics. The opposite is true for the other `r nrow(women_split_aws_lower)` topics (`r women_split_aws_lower$topic_name`), which AWS MPs are significantly less likely and non-AWS MPs are significantly more likely to mention than male Labour MPs.

However, an estimate being statistically significant -- i.e. estimates for AWS and non-AWS MPs where the _p_ value as reported in Table \@ref(tab:estimate-table-k0) is < 0.05 -- does not tell us anything about the relative value of those frequency differences. For example, in topic 21, Benefits and disability, frequency estimates for both AWS and non-AWS MPs are  significantly different (_p_ < 0.05) from the frequency estimate for male Labour MPs. However, while the frequency value for the benefits and disability topic is `r scales::percent(as.numeric(effect_compare$estimate[effect_compare$type=="Male" & effect_compare$topic==21]))` for male MPs, and `r scales::percent(as.numeric(effect_compare$estimate[effect_compare$type=="Non-AWS" & effect_compare$topic==21]))` for non-AWS MPs, it is `r scales::percent(as.numeric(effect_compare$estimate[effect_compare$type=="AWS" & effect_compare$topic==21]))` for AWS MPs. Non-AWS Labour MPs are only slightly more likely to bring up benefits and disability than male Labour MPs, while AWS MPs discuss it almost twice as much as their male colleagues. 
...
```{r p-effect1, echo=FALSE, fig.height=9, fig.width=7, fig.cap="Where AWS MPs are most distinct from non-AWS female MPs"}

scale_perc <- function(x) paste0(formatC(round((x*100), 3),
                                  format='f', digits=2), "%")

topic_list_cv_fem <- top_n(effect_compare2, 12, cv_fem)

p_effect <- ggplot(effect_compare %>%
                        filter(assigned_topic %in% 
                                 topic_list_cv_fem$assigned_topic) %>%
                        left_join(topic_list_cv_fem) %>%
                        arrange(desc(cv_fem)) %>%
                        mutate(assigned_topic = factor(assigned_topic,
                                                       unique(assigned_topic))),
  ...
  facet_wrap(~assigned_topic, ncol = 3, scales = "free_x")

p_effect


ggsave("p14_effect.svg", plot = p_effect,
       path="plots", device = "svg", width = 20, height = 20, units = "cm")
```


```{r p-effect2, echo=FALSE, fig.height=9, fig.width=7, fig.cap="Where AWS MPs are most similar to non-AWS female MPs"}

topic_list_cv_fem <- top_n(effect_compare2, -12, cv_fem)

p_effect_diff <- ggplot(effect_compare %>%
                        filter(assigned_topic %in% 
                                 topic_list_cv_fem$assigned_topic) %>%
                        left_join(topic_list_cv_fem) %>%
                        arrange(cv_fem) %>%
...
ggsave("p15_effect_diff.svg", plot = p_effect_diff,
       path="plots", device = "svg", width = 20, height = 20, units = "cm")
```


```{r p-effect-cv, echo=FALSE, fig.height=9, fig.width=7, fig.cap="Topics with the greatest frequency coefficient of variation"}

topic_list_cv <- top_n(effect_compare2, 12, cv)

p_effect_cv <- ggplot(effect_compare %>%
                        filter(assigned_topic %in%
                                 topic_list_cv$assigned_topic) %>%
                        left_join(topic_list_cv) %>%
                        arrange(desc(cv)) %>%
                        mutate(assigned_topic = factor(assigned_topic,
                                                       unique(assigned_topic))),
                     aes(y = estimate, x = covariate.value,
...
ggsave("p16_effect_diff.svg", plot = p_effect_cv,
       path="plots", device = "svg", width = 20, height = 20, units = "cm")
```
...
# this is becoming a list and fucking up tables when it starts with the number, 
   # have tried changing it to end with the topic number instead 
   # to see if that works
kable(prep_df_k0_gender_2, booktabs = TRUE, longtable = TRUE,
      caption = "Topic Estimates (Gender)",
      col.names = c("", "", "Estimate", "Standard Error",
                    "t value", "Pr(>|t|)"),
      align = c("l","r","r","r","r", "l")) %>%
    kable_styling(bootstrap_options = c("basic", "HOLD_position")) %>%
...
#               align = "left", part = "all") %>%
#   align(j = c("Estimate", "Std. Error", "t value", "p"),
#         align = "right", part = "all") %>% autofit() %>% knit_print()
# prep_df_k0_gender_2
 }
```
...
Using the frequency of a topic among male MPs as a baseline, there are `r sum(effect_compare2$fem_relative == "AWS more like male")` topics where the frequency among AWS MPs is proportionally closer, in absolute terms, than the frequency of the topic among female MPs. The inverse is true for the remaining `r sum(effect_compare2$fem_relative == "Non-AWS more like male")` topics.

Relative to each other, there are `r sum(effect_compare2$all_diffs == "Women more similar to each other")` topics where the frequency between AWS and non-AWS MPs are closer to each other than either is to the topic frequency in male MPs. In `r sum(effect_compare2$all_diffs == "AWS more like male")` topics, the frequency between AWS and male MPs are the most similar, and in the remaining `r sum(effect_compare2$all_diffs == "Non-AWS more like male")` topics the difference in frequency are smallest between non-AWS and male MPs. See Table \@ref(tab:absolute-differences) for details.

```{r absolute-differences, echo=FALSE}

effect_compare3 <- effect_compare2 %>%
  select(assigned_topic, fem_relative, all_diffs)

# effect_compare3$assigned_topic <- recode(
#   effect_compare3$assigned_topic,
#   "(1) Employment & unions" = "Employment & unions (1)",
#   "(2) Legal system" = "Legal system (2)",
#   "(3) Roads" = "Roads (3)",
#   "(4) Housing" = "Housing (4)",
#   "(5) Police firefighters & prison" = "Police firefighters & prison (5)",
#   "(6) Northern Ireland" = "Northern Ireland (6)",
#   "(7) Committee" = "Committee (7)",
#   "(8) Schools" = "Schools (8)",
#   "(9) Energy & climate change" = "Energy & climate change (9)",
#   "(10) Defence" = "Defence (10)",
#   "(11) Parliament" = "Parliament (11)",
#   "(12) International politics" = "International politics (12)",
#   "(13) Ministers" = "Ministers (13)",
#   "(14) Policy impact" = "Policy impact (14)",
#   "(15) Gender" = "Gender (15)",
#   "(16) Regional development" = "Regional development (16)",
#   "(17) Communications" = "Communications (17)",
#   "(18) Immigration" = "Immigration (18)",
#   "(19) Health system" = "Health system (19)",
#   "(20) International development" = "International development (20)",
#   "(21) Benefits & disability" = "Benefits & disability (21)",
#   "(22) Sport & culture" = "Sport & culture (22)",
#   "(23) History" = "History (23)",
#   "(24) Higher education & skills" = "Higher education & skills (24)",
#   "(25) Concurring point" = "Concurring point (25)",
#   "(26) Pensions" = "Pensions (26)",
#   "(27) Points of order" = "Points of order (27)",
#   "(28) Issues" = "Issues (28)",
#   "(29) Constituencies" = "Constituencies (29)",
#   "(30) Ethnic groups & racism" = "Ethnic groups & racism (30)",
#   "(31) Amendments" = "Amendments (31)",
#   "(32) Reports" = "Reports (32)",
#   "(33) People" = "People (33)",
#   "(34) Wales & Scotland" = "Wales & Scotland (34)",
#   "(35) Alcohol & tobacco" = "Alcohol & tobacco (35)",
#   "(36) Place names" = "Place names (36)",
#   "(37) Budget" = "Budget (37)",
#   "(38) Tax" = "Tax (38)",
#   "(39) Private companies" = "Private companies (39)",
#   "(40) Environment & fishing" = "Environment & fishing (40)",
#   "(41) Crime" = "Crime (41)",
#   "(42) Bills" = "Bills (42)",
#   "(43) Children" = "Children (43)",
#   "(44) Utilities & PFI" = "Utilities & PFI (44)",
#   "(45) Middle East" = "Middle East (45)",
#   "(46) Local authorities" = "Local authorities (46)",
#   "(47) Elections" = "Elections (47)",
#   "(48) Debate" = "Debate (48)",
#   "(49) Transport" = "Transport (49)",
#   "(50) Questions" = "Questions (50)",
#   "(51) Families" = "Families (51)",
#   "(52) Health research" = "Health research (52)",
#   "(53) Dispatch box" = "Dispatch box (53)",
#   "(54) Parties" = "Parties (54)",
#   "(55) Statements" = "Statements (55)",
#   "(56) European Union" = "European Union (56)",
#   "(57) Locations" = "Locations (57)",
#   "(58) Jobs & manufacturing" = "Jobs & manufacturing (58)",
#   "(59) Small business" = "Small business (59)",
#   "(60) Agreement & disagreement" = "Agreement & disagreement (60)",
#   "(61) Voluntary sector" = "Voluntary sector (61)",
#   "(62) Comments" = "Comments (62)",
#   "(63) Social care" = "Social care (63)",
#   "(64) Time" = "Time (64)",
#   "(65) Media & animals" = "Media & animals (65)",
#   "(66) Other" = "(66) Other")

if (knitr::is_latex_output()) {
kable(effect_compare3, booktabs = TRUE, longtable = TRUE,
      caption = "Absolute Differences",
      col.names = c("Topic", "Women Relative to Male MPs",
                    "Most Similar")) %>%
    kable_styling(latex_options = c("basic", "HOLD_position",
                                    "repeat_header"), full_width = TRUE) %>%
...
ggsave("p17_theta_distribution.svg", plot = p_theta,
       path="plots", device = "svg", width = 20, height = 20, units = "cm")
