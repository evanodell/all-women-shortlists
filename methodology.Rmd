...
prep_df_k0$type <- gsub("genderMale", "Men", prep_df_k0$type)
...
ggsave("p_k0_prop.svg", plot = p_k0_prop,
       path="plots", device = "svg", width = 20, height = 20, units = "cm")
...
-- need to work out putting the names and proportion results into this text
