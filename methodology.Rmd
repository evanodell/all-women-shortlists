...
1. Re-run topic model assignments, excluding as_speaker==TRUE

1. Re-run spacyr, excluding as_speaker==TRUE
...
```{r lab-desc-stats-table, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
library(knitr)
library(kableExtra)
library(dplyr)
...
fem_keyness_plot <- textplot_keyness(lab_keyness_fem, n=25) + 
  scale_color_manual(labels = c("Non-AWS", "AWS"),
                     values = c("grey", "darkblue"), name = NULL) +
