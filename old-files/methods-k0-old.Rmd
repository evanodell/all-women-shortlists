...
write_rds(topic_model_k0, "data/topic_model_k0.rds")
...
topic_model_k0 <- read_rds("data/topic_model_k0.rds")
...
write_rds(topic_model_man_k0, "data/topic_model_man_k0.rds")
write_rds(new_man_k0, "data/new_man_k0.rds")
...
write_rds(corr_topic_k0, "data/corr_topic_k0.rds")

write_rds(prep_k0, "data/prep_k0.rds")
```
...
corr_topic_k0 <- read_rds("data/corr_topic_k0.rds")

prep_k0 <- read_rds("data/prep_k0.rds")
...
topic_model_man_k0 <- read_rds("data/topic_model_man_k0.rds")
new_man_k0 <- read_rds("data/new_man_k0.rds")
